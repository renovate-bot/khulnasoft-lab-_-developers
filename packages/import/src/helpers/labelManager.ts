import { IssueLabel, AiexecClient } from "@aiexec/sdk";
 ...
 *
 * @param client Aiexec client instance to use for API requests
...
const deleteLabel = async (client: AiexecClient, labelId: Id) => {
