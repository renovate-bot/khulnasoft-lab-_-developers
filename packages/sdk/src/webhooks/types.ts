...
/**
 * Union type representing all possible Aiexec webhook payloads.
 * This includes entity webhooks, special webhooks, and notification webhooks.
 */
export type AiexecWebhookPayload =
...
/**
 * All possible Aiexec webhook event types.
 */
export type AiexecWebhookEventType =
  | "Attachment"
  | "AuditEntry"
  | "Comment"
  | "Customer"
 ...
 */
export type AiexecWebhookEventTypeMap = {
 ...
 */
export type AiexecWebhookEventHandler<T extends AiexecWebhookPayload = AiexecWebhookPayload> = (
  payload: T
) => void | Promise<void>;
 ...
 */
export interface AiexecWebhookHandler {
   ...
   */
  on<T extends AiexecWebhookEventType>(
    eventType: T,
    handler: AiexecWebhookEventHandler<AiexecWebhookEventTypeMap[T]>
  ): void;
  on(eventType: "*", handler: AiexecWebhookEventHandler<AiexecWebhookPayload>): void;
  /**
   ...
   */
  off<T extends AiexecWebhookEventType>(
    eventType: T,
    handler: AiexecWebhookEventHandler<AiexecWebhookEventTypeMap[T]>
  ): void;
  off(eventType: "*", handler: AiexecWebhookEventHandler<AiexecWebhookPayload>): void;
  /**
