/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b7e288b69101ab8c1e57a7f543dca999)
// Runtime types generated with workerd@1.20250508.0 2025-05-12 nodejs_compat
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        "OPENAI_API_KEY" | "AIEXEC_CLIENT_ID" | "AIEXEC_CLIENT_SECRET" | "URL" | "AIEXEC_WEBHOOK_SECRET"
      >
    > {}
}
...
type GatewayRetries = {
  ...
  retryDelayMs?: number;
  backoff?: "constant" | "aiexec" | "exponential";
};
type GatewayOptions = {
  id: string;
  cacheKey?: string;
...
declare module "cloudflare:workers" {
  ...
  export type WorkflowBackoff = "constant" | "aiexec" | "exponential";
