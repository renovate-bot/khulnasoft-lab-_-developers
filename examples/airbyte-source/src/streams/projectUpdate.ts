...
import { ProjectUpdate as Model } from "../client/types";

export class ProjectUpdate extends AirbyteStreamBase {
  public constructor(
  ...
  public getJsonSchema(): Dictionary<unknown> {
    return require("../../resources/schemas/projectUpdate.json");
  }
  ...
  public async *readRecords(): AsyncGenerator<Model> {
    const result = await this.client.projectUpdates();
