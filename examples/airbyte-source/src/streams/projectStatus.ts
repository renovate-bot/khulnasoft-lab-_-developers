...
import { Project as Model } from "../client/types";

export class ProjectStatus extends AirbyteStreamBase {
  public constructor(
  ...
  public getJsonSchema(): Dictionary<unknown> {
    return require("../../resources/schemas/projectStatus.json");
  }
  ...
  public async *readRecords(): AsyncGenerator<Model> {
    const result = await this.client.projectStatuses();
