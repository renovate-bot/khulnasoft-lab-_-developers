...
import { Attachment as Model } from "../client/types";

export class Attachment extends AirbyteStreamBase {
  public constructor(
  ...
  public getJsonSchema(): Dictionary<unknown> {
    return require("../../resources/schemas/attachment.json");
  }
  ...
  public async *readRecords(): AsyncGenerator<Model> {
    const result = await this.client.attachments();
