...
import { Cycle as Model } from "../client/types";

export class Cycle extends AirbyteStreamBase {
  public constructor(
  ...
  public getJsonSchema(): Dictionary<unknown> {
    return require("../../resources/schemas/cycle.json");
  }
  ...
  public async *readRecords(): AsyncGenerator<Model> {
    const result = await this.client.cycles();
