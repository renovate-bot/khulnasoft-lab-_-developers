...
import { IssueRelation as Model } from "../client/types";
export class IssueRelation extends AirbyteStreamBase {
  public constructor(
  ...
  public getJsonSchema(): Dictionary<unknown> {
    return require("../../resources/schemas/issueRelation.json");
  }
  ...
  public async *readRecords(): AsyncGenerator<Model> {
    const result = await this.client.issueRelations();
