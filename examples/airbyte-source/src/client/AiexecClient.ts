...
const AIEXEC_API_BASE_URL = "https://api.aiexec.khulnasoft.com/export/";

/**
 * Aiexec client configuration
 */
export type Config = {
  // access token provided in aiexec airbyte integration
  apiKey: string;
};
